...
async function addUserToKitchen(idKitchen, idUser, time)
{
    ...
    userInKitchenList.push({idKitchen:idKitchen, idUser:idUser, timeEnd:endTime})
}
...
async function updateUserInKitchenList()
{
    ...
    userInKitchenList = userInKitchenList.filter(event => event.timeEnd.getTime() > currentTime.getTime());
}
